...
(defgeneric + (o1 o2 &rest others))
(defmethod + (o1 o2 &rest others)
  (apply #'common-lisp:+ o1 o2 others))
(defmethod + ((o1 vect) (o2 vect) &rest others)
  (declare (ignore others))
  (add-vect o1 o2))
(defmethod + ((o1 color) (o2 color) &rest others)
  (declare (ignore others))
  (add-color o1 o2))
